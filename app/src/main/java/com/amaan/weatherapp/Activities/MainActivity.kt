...
import com.amaan.weatherapp.Models.WeatherModel
import com.amaan.weatherapp.R
import com.amaan.weatherapp.Utilites.ApiUtilities
import com.amaan.weatherapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey="e96858c0c7ae86ea0c8cbed45664f744"
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        val notification = NotificationCompat.Builder(this,CHANNEL_ID)
            ...
            .setContentText("Hi!!!! Time to get a daily check on the weather!!!")
            .setSmallIcon(R.drawable.ic_few_clouds)
